...
class YarnShuffleServiceSuite extends SparkFunSuite with Matchers with BeforeAndAfterEach {
  ...
  test("SPARK-31646: metrics should be registered into Node Manager's metrics system") {
    ...
    assert(metrics.keySet().asScala.toSeq.sorted == Seq(
      ...
      "shuffleIndexCacheHitRate",
      "shuffleIndexCacheMissRate",
      "shuffleIndexCacheRequestCount",
      "shuffleIndexCacheHitCount",
      "shuffleIndexCacheMissCount",
      "shuffleIndexCacheLoadSuccessCount",
      "shuffleIndexCacheLoadExceptionCount",
      "shuffleIndexCacheTotalLoadTimeNanos",
      "shuffleIndexCacheAverageLoadPenaltyNanos",
      "shuffleIndexCacheEvictionCount",
      "shuffleIndexCacheSize",
      "shuffleIndexCacheRetainedMemorySizeBytes",
      "shuffleIndexCacheMaxMemorySizeBytes",
